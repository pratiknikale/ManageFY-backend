...
const app = express();
const manageEmployee = express.Router();
let users = require("../models/users");
const auth = require("../middleware/auth");

manageEmployee.get("/get", auth, (req, res) => {
  ...
  if (role === "manager") {
    try {
      const mylist = async () => {
        ...
        const data = await users.find({ role: "employee" });
        res.json(data);
      };
...
// manageEmployee.get('/getId/:id', auth, (req, res) => {
//     try{
//         const mylist = async () => {
//             const user = req.userID;
...
// manageEmployee.put('/updateStatus', auth, (req, res, next) => {
//     // console.log(req.body)
//     try{
//         const mylist = async () => {
//             const user = req.userID;
...
// manageEmployee.put('/edit', auth, (req, res, next) => {
...
// manageEmployee.post('/insert', auth, (req,res) => {
//     // console.log(req.body)
//     try{
//         const addTask = async () => {
//             const user = req.userID;
...
// manageEmployee.delete('/delete/:id', (req,res) => {
//     try{
